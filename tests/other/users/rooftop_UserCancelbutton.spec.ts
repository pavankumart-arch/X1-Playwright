...
test.describe('rooftop User Cancel Button Validation', () => {
  test('Verify rooftopuser Cancel button closes the Add User form', async ({ page }, testInfo) => {
 ...
 // Step 1 & Step 2
  ...
  await page.waitForLoadState('networkidle');
    ...
    const verifyrooftopUserCancelButton=new VerifyrooftopUserCancelButton(page);
    await verifyrooftopUserCancelButton.verifyrooftopUserCancelButton(testInfo);
  });
});