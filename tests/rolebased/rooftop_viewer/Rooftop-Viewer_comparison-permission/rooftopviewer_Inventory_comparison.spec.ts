...
import AddRooftopData from '../../../../testdata/comparison/Rooftopdata.json';
...
test.describe('Reseller Level Vehicle Permissions', () => {
    ...
    test('Verify Reseller Admin 1 and Reseller Admin 2 Vehicle Data', async ({ browser }, testInfo: TestInfo) => {
        ...
        await admin1Login.loginByRole('rooftop_viewer' as any);
        await page1.waitForTimeout(1000)

        console.log('✅ Reseller Admin 1 Login successful');
        ...
        await inventoryNavigation1.searchAndOpenRecord(AddRooftopData.Rooftopviwer1, testInfo);
        ...
        await admin2Login.loginByRole('rooftop_viewer3' as any);
        await page2.waitForTimeout(1000)

        console.log('✅ Reseller Admin 2 Login successful');
        ...
        await inventoryNavigation2.searchAndOpenRecord(AddRooftopData.Rooftopviwer3, testInfo);
