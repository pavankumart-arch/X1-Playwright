...
import { UserTypeSorting } from '../../../pages/Systemconfig/UserTypes/UserTypeSorting';
...
test(
  ...
  async ({ page }, testInfo: TestInfo) => {
    ...
    console.log(`\n${'='.repeat(60)}`);
    console.log(`RUNNING USER TYPE SORTING TESTS`);
    ...
    for (const column of columnsToTest) {
      ...
      try {
        ...
        const result =
          await userTypeSorting.validateColumnSorting(
            column,
            testInfo
          );
