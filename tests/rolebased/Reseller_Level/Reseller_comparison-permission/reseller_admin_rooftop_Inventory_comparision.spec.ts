...
test.describe('Reseller Level Vehicle Permissions', () => {
    ...
    test('Verify Reseller Admin 1 and Reseller Admin 2 Vehicle Data', async ({ browser }, testInfo: TestInfo) => {
        ...
        await admin1Login.loginByRole('Reseller_Admin' as any);
        ...
        await inventoryNavigation1.searchAndOpenRecord(rooftopdata.Rooftop1, testInfo);
        ...
        await admin2Login.loginByRole('Reseller_Admin2' as any);
        ...
        await inventoryNavigation2.searchAndOpenRecord(rooftopdata.Rooftop2, testInfo);
