...
export class NavGroupSorting extends BasePage {
  ...
  constructor(page: Page) {
    ...
    console.log('✅ NavGroupSorting Loaded');
  }
  ...
  async getHeader(columnName: string): Promise<Locator> {
    ...
    throw new Error(
      `Column header not found: ${columnName}`
    );
  }
  ...
  async getColumnIndex(
    ...
    throw new Error(
      `Column index not found: ${columnName}`
    );
  }
  ...
  async validateColumnSorting(
    ...
    try {
      ...
      const firstAsc =
        this.isSortedAscending(firstValues);

      const firstDesc =
        this.isSortedDescending(firstValues);
      ...
      const secondAsc =
        this.isSortedAscending(secondValues);

      const secondDesc =
        this.isSortedDescending(secondValues);
