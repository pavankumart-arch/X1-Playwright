...
export class TrimSearch {
  ...
  constructor(page: Page) {
    ...
    this.searchInput =
      page.locator('input.table-search__input');

    this.noDataMessage =
      page.locator('td.table-body__cell--empty p');

    this.nextButton =
      page.locator(this.nextButtonSelector);

    this.previousButton =
      page.locator(this.previousButtonSelector);
  }
  ...
  async goToFirstPage() {
    ...
    try {
      ...
      console.log('Pagination reset skipped');
  ...
  async verifyTrimSearch(
    ...
    console.log(
      'TRIM SEARCH VALIDATION STARTED'
    );
    console.log(
      '====================================\n'
    );
    ...
    await this.searchByTrimName(testInfo);

    await this.searchByCreatedDate(testInfo);

    await this.searchByStatus(testInfo);

    await this.invalidTrimNameSearch(testInfo);

    console.log(
      '\n===================================='
    );
    console.log(
      'TRIM SEARCH VALIDATION COMPLETED'
    );
    console.log(
      '====================================\n'
    );
